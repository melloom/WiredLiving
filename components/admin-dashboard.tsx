              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      // Generate SEO content from existing post data
                      const title = formData.title || 'Untitled Post';
                      const description = formData.description || formData.content.substring(0, 160) || '';

                      // Generate SEO title (max 60 chars recommended)
                      let seoTitle = title;
                      if (seoTitle.length > 60) {
                        seoTitle = seoTitle.substring(0, 57) + '...';
                      }

                      // Generate SEO description (max 160 chars recommended)
