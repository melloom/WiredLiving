...
export const metadata: Metadata = {
  title: 'Contact Melvin | Get in Touch',
  description: 'Get in touch with Melvin for collaborations, freelance work, questions, or just to say hello. Always open to new opportunities and conversations.',
  keywords: [
    'Contact',
    'Get in Touch',
    'Melvin',
  ...
  openGraph: {
    ...
    description: 'Get in touch with Melvin for collaborations, freelance work, questions, or just to say hello.',
