...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  const csp = [
    ...
    "connect-src 'self' https://newsapi.org https://eventregistry.org https://eventregistry.org/api/v1/article https://eventregistry.org/api/v1/article/getArticles https://*.supabase.co https://api.openweathermap.org https://wttr.in https://noembed.com",
    "media-src 'self' https://*.supabase.co blob: data:",
    "frame-src 'self' https://vercel.live https://platform.twitter.com https://www.youtube.com https://youtube.com",
    "manifest-src 'self'",
